        ...
        container.innerHTML = momentsData.map(moment => {
            ...
            return `<div class="moments-item">
                <div class="moments-item-header">
                    ...
                    ${isMine ? `<button class="moments-delete-btn" onclick="window.deleteMomentById('${moment.id}')"><i class="fas fa-trash-alt"></i></button>` : ''}
                </div>
